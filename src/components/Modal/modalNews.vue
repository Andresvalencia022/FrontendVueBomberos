        ...
        <form class="block px-9 pb-5" @submit.prevent="addEvent()">
          ...
          <div class="flex sm:col-span-4">
            <div class="w-1/2 px-0.5">
              ...
              >
              <div class="mt-2">
                <input class="lock w-full rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-black focus:border-black p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" id="default_size" type="file">
                <p
