...
<template>
  <div>
   ...
   {{ alertStore.message }}
    ...
    <!-- ✅ Si hay noticia, muestra la lista -->
    <div class="m-10" v-else-if="NewsStore.arrayNews.length > 0">
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-for="New in NewsStore.arrayNews.slice(0, 5)" :key="New.id" :New="New"
            ...
            <td class="px-6 py-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                class="bi bi-camera-video-fill text-gray-800" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
                  d="M0 5a2 2 0 0 1 2-2h7.5a2 2 0 0 1 1.983 1.738l3.11-1.382A1 1 0 0 1 16 4.269v7.462a1 1 0 0 1-1.406.913l-3.111-1.382A2 2 0 0 1 9.5 13H2a2 2 0 0 1-2-2z" />
              </svg>
            </td>
            <td class="px-2 py-4 flex">
              <a class="inline-block p-2" @click="show_modalDetalle('news_details', New.id)">
              ...
              <a class="inline-block p-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="w-6 h-6 text-green-500 hover:text-green-700"
              ...
              <a class="inline-block p-2" @click="newDelete(New.id)">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                  stroke="currentColor" class="w-6 h-6 text-red-600 hover:text-red-900">
                  <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div v-else class="flex flex-col items-center justify-center p-10 mx-3 bg-white rounded-lg">
      ...
      <p class="text-gray-600 dark:text-gray-600 text-md mt-2 text-center max-w-md leading-relaxed">
