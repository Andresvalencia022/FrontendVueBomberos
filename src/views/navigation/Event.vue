...
<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="w-full p-6 h-auto bg-gray-300 border border-gray-400 rounded-xl shadow-lg "
        >
          <!-- Título y acciones -->
          <div class="flex items-center justify-between mb-4">
            <h5
              class="w-8/12 text-lg font-bold tracking-wide text-black truncate"
            >
              {{ event.event_name }}
            </h5>
          ...
          <!-- Fechas del evento -->
          <div
            class="grid grid-cols-2 gap-4 mb-6 text-gray-800"
          >
    ...
    >
      ...
      <p
        class="text-gray-800 dark:text-gray-500 text-md mt-2 text-center max-w-md leading-relaxed"
      >
